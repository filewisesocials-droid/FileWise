...
export const Footer: React.FC<FooterProps> = ({ setActiveTab }) => {
  return (
    <footer className="bg-slate-900 text-slate-400 text-xs border-t border-slate-800 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded bg-slate-800 p-0.5 shadow-sm flex items-center justify-center shrink-0 border border-slate-700">
              <img 
            ...
            <span className="font-serif font-extrabold text-lg text-white tracking-tight">FILEWISE</span>
          </div>
        ...
        {/* Quick Links */}
        <div>
          <h4 className="font-serif font-bold text-white text-xs uppercase tracking-wider mb-3">Service Portals</h4>
          <ul className="space-y-2">
            <li>
              <button onClick={() => setActiveTab('search')} className="hover:text-amber-400 transition-colors">
            ...
            <li>
              <button onClick={() => setActiveTab('inquiry')} className="hover:text-amber-400 transition-colors">
                Submit General Inquiry
              </button>
            </li>
            <li>
              <button onClick={() => setActiveTab('tracking')} className="hover:text-amber-400 transition-colors">
            ...
            <li>
              <button onClick={() => setActiveTab('terms')} className="hover:text-amber-400 transition-colors">
                Terms &amp; Conditions
              </button>
            </li>
          </ul>
        ...
        {/* Core Capabilities */}
        <div>
          <h4 className="font-serif font-bold text-white text-xs uppercase tracking-wider mb-3">Core Capabilities</h4>
        ...
        {/* Contact & Support */}
        <div>
          <h4 className="font-serif font-bold text-white text-xs uppercase tracking-wider mb-3">Pretoria Hub</h4>
          <div className="space-y-2.5">
            ...
            <a href="https://api.whatsapp.com/send?phone=27502154465&text=Hello%20FileWise%20Team%2C%20I%20have%20an%20inquiry." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors">
          ...
          <div className="mt-4 pt-3 border-t border-slate-800">
            <h5 className="font-bold text-slate-300 text-[11px] uppercase tracking-wider mb-2">Follow Us Online</h5>
            <div className="flex items-center gap-2">
              {/* Facebook */}
              <a
                ...
                className="w-7 h-7 rounded bg-slate-800 hover:bg-amber-500 hover:text-slate-950 text-slate-300 flex items-center justify-center transition-all"
              >
      ...
      <div className="bg-slate-950 border-t border-slate-800 py-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-500">
          ...
          <div className="flex items-center gap-4">
            <button onClick={() => setActiveTab('about')} className="hover:text-amber-400 transition-colors">About Us</button>
            <button onClick={() => setActiveTab('contact')} className="hover:text-amber-400 transition-colors">Contact Us</button>
            <button onClick={() => setActiveTab('terms')} className="hover:text-amber-400 transition-colors">Terms &amp; Conditions</button>
          </div>
        </div>
      </div>
